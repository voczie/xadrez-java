...
public class JanelaPrincipal extends JFrame {
    ...
    public void reagir(CasaGUI casaClicada) {
        if (primeiroClique) {
            if (casaClicada.possuiPeca()) {
                ...
                if(jogo.checarTurno(turnoJogo, casaClicadaOrigem.getPosicaoX(), casaClicadaOrigem.getPosicaoY())){
                    casaClicadaOrigem.destacar();
                    primeiroClique = false;
                }
                else{
                    if(turnoJogo == 0){
                        JOptionPane.showMessageDialog(this, "Turno das peças brancas!");
                    }
                    else if(turnoJogo == 1){
                        JOptionPane.showMessageDialog(this, "Turno das peças pretas!");
                    }
                }
                atualizar();
            }
    ...
    public JanelaPrincipal() {
        ...
        this.turnoJogo = 0; //0 para peca branca, 1 para peca preta
